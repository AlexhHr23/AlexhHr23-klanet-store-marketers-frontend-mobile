          ...
          child: Column(
            ...
            children: [
              SizedBox(
                ...
                child: Stack(
                  children: [
                    _ImageViewer(imageUrl: product.producto.fotos[0].archivo),
                    Positioned(
                      top: 8,
                      right: 8,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text(
                        '\$${product.producto.precioDescuento.toStringAsFixed(2)}${product.producto.moneda}',
